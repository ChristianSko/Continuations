...
class CheckContinuationNetworkManager {
    ...
    func getDataFromSDKThatConformToAsyncAwait(url: URL) async throws -> Data {
        do {
    ...
    func getDataFromSDKThatNOTConformToAsyncAwait(url: URL) async throws -> Data {
...
class CheckedContinuationViewModel: ObservableObject {
    ...
    func getImage() async {
        ...
        do {
            let data = try await networkManager.getDataFromSDKThatConformToAsyncAwait(url: url)
